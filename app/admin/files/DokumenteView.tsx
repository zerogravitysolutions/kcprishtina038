...
/**
 * The document library, formerly /admin/documents: upload plus full CRUD on
 * each row. The gate lives on the page — this view is only ever rendered behind
 * it, and every write is re-checked in app/admin/documents/actions.ts.
 */
export async function DokumenteView() {
